...
class Furnizimi extends Database{
    public function index(){
        $sql = "select f.id,l.titulli,f.sasia_furnizimit,f.cmimi_sasi,f.data_porosise,f.data_arritjes,f.zbritje,f.created_at from furnizimet f join librat l on f.libri_id=l.id";
